<template>
    <div>
        <ul>
            ...
            <li class="relative px-5 py-2">
                <span v-if="isUrl(`auth`)" class="absolute inset-y-0 left-0 w-1 bg-indigo-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
            ...
            <li v-if="auth.user.role === 'Супер Администратор' || auth.user.role === 'Администратор'" class="relative px-5 py-2">
                <span v-if="isUrl('users')" class="absolute inset-y-0 left-0 w-1 bg-indigo-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>

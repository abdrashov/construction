    ...
    <div>
        <ul>
            <li class="relative px-5 py-2">
                <span v-if="isUrl('')" class="absolute inset-y-0 left-0 w-1 bg-sky-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
            ...
            <li class="relative px-5 py-2">
                <span v-if="isUrl(`auth`)" class="absolute inset-y-0 left-0 w-1 bg-sky-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                <Link :href="`/auth/${auth.user.id}`" class="inline-flex items-center w-full text-sm font-semibold text-gray-900 transition-colors duration-150 hover:text-gray-600">
                    <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li class="relative px-5 py-2">
                <span v-if="isUrl('logout')" class="absolute inset-y-0 left-0 w-1 bg-sky-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                <Link href="/logout" method="delete" as="button" class="inline-flex items-center w-full text-sm font-semibold text-gray-900 transition-colors duration-150 hover:text-gray-600">
                    <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li v-if="auth.user.role === 'Супер Администратор' || auth.user.role === 'Администратор' ||auth.user.role === 'Бухгалтер'" class="relative px-5 py-2">
                <span v-if="isUrl('organizations', 'invoices')" class="absolute inset-y-0 left-0 w-1 bg-sky-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
            ...
            <li v-if="auth.user.role === 'Супер Администратор' || auth.user.role === 'Кассир' ||auth.user.role === 'Бухгалтер'" class="relative px-5 py-2">
                <span v-if="isUrl('reports')" class="absolute inset-y-0 left-0 w-1 bg-sky-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
            ...
            <li v-if="auth.user.role === 'Супер Администратор' || auth.user.role === 'Администратор'" class="relative px-5 py-2">
                <span v-if="isUrl('users')" class="absolute inset-y-0 left-0 w-1 bg-sky-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                <Link href="/users" class="inline-flex items-center w-full text-sm font-semibold text-gray-900 transition-colors duration-150 hover:text-gray-600">
                    <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li v-if="auth.user.role === 'Супер Администратор' || auth.user.role === 'Бухгалтер'" class="relative px-5 py-2">
                <span v-if="isUrl('reference/suppliers')" class="absolute inset-y-0 left-0 w-1 bg-sky-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
            ...
            <li v-if="auth.user.role === 'Супер Администратор' || auth.user.role === 'Бухгалтер'" class="relative px-5 py-2">
                <span v-if="isUrl('reference/items')" class="absolute inset-y-0 left-0 w-1 bg-sky-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
            ...
            <li v-if="auth.user.role === 'Супер Администратор' || auth.user.role === 'Бухгалтер'" class="relative px-5 py-2">
                <span v-if="isUrl('reference/measurements')" class="absolute inset-y-0 left-0 w-1 bg-sky-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>

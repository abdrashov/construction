<template>
    <div>
        ...
        <h1 class="mb-6 text-2xl font-bold">
            <Link class="text-indigo-400 hover:text-indigo-600" href="/reference/measurements">Измерение</Link>
        ...
        <div class="max-w-3xl overflow-hidden bg-white rounded-md shadow">
            <form @submit.prevent="update">
                ...
                <div class="flex items-center px-8 py-4 border-t border-gray-100 bg-gray-50">
                    <button v-if="!measurement.deleted_at" class="text-red-600 hover:underline" tabindex="-1" type="button" @click="destroy">Удалить</button>

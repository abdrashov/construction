        ...
        <div class="mt-6 overflow-x-auto text-sm bg-white rounded shadow">
            <table class="w-full">
                <tr class="font-bold text-left">
                    ...
                    <th class="px-5 pt-5 pb-3">Поставщик</th>
                    <th class="px-5 pt-5 pb-3">Принял</th>
                    <th class="px-5 pt-5 pb-3">Статус</th>
                    <th colspan="2" class="px-5 pt-5 pb-3">Дата</th>
                </tr>
                <tr v-for="invoice in organization.invoices" :key="invoice.id">
                    <td class="border-t">
                        <Link class="flex items-center px-5 py-2" :href="`/invoices/${invoice.id}/invoice-items`">
                            {{ invoice.name }}
                            <icon v-if="invoice.deleted_at" name="trash" class="flex-shrink-0 w-3 h-3 ml-2 fill-gray-400" />
                        </Link>
                    </td>
                    <td class="border-t">
                        <Link class="flex items-center px-5 py-2" :href="`/invoices/${invoice.id}/invoice-items`" tabindex="-1">
                            {{ invoice.supplier }}
                        </Link>
                    </td>
                    <td class="border-t">
                    ...
                    <td class="w-px border-t">
                        <div class="pr-2">
                            ...
                            >
                                <div class="flex items-center h-4">Товары</div>
                            </Link>
                        </div>
                    </td>
                </tr>

        ...
        <div class="text-sm bg-white shadow overflow-x-auto">
            <table class="w-full">
                ...
                <tr v-for="(history, index) in expenses_histories.data" :key="history.id">
                    ...
                    <td class="border-l border-t">
                        <div class="flex items-center px-2 py-3 whitespace-nowrap text-gray-900">
                            {{ history.date }}
                        </div>
                    </td>
                    <td class="border-l border-t">
                    ...
                    <td class="w-16 border-l border-t">
                        <div class="flex items-center justify-end px-4 py-1">
                            <Link :href="`/expense-common/${expense.id}/${history.id}`" method="delete" as="button" class="focus:shadow-outline-gray flex items-center justify-end ml-2 px-2 py-2 text-gray-500 hover:text-red-400 text-xs font-medium leading-5 bg-gray-100 hover:bg-red-100 rounded-lg focus:outline-none duration-200" >

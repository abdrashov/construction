                ...
                <tr v-for="(item, index) in invoice_items" :key="item.id">
                    ...
                    <td class="w-1/6 border-l border-t">
                        <div class="flex items-center px-4 py-1">
                            <input v-maska="'#*.####'" v-model.lazy="item.count" @change="countHandler(index)" :name="`item[${index}][count]`" class="mr-1 border-b border-dashed border-blue-300" />
                            <span>{{ item.measurement }}</span>
                        </div>
                    </td>
                    <td class="w-1/6 border-l border-t">
                        <div class="flex items-center px-4 py-1">
                            <input v-maska="'#*.##'" v-model.lazy="item.price" @change="priceHandler(index)" :name="`item[${index}][price]`" class="border-b border-dashed border-blue-300" />
                        </div>
                    </td>
                    <td class="w-2/6 border-l border-t">
